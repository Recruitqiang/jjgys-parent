...
@HeadRowHeight(30)
public class JjgFbgcLjgcZddmccVo extends BaseRowModel {

    @ColumnWidth(23)
    @ExcelProperty(value = "桩号及位置" ,index = 0)
    private String zhjwz;

    @ColumnWidth(23)
    @ExcelProperty(value = "抽检桩号" ,index = 1)
    private String cjzh;
    ...
    @ColumnWidth(23)
    @ExcelProperty(value = "允许误差-(mm)" ,index = 7)
    private String yxwcf;

    @ColumnWidth(23)
    @ExcelProperty(value = "检测日期" ,index = 8)
